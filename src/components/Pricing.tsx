...
const Pricing: React.FC = () => {
  return (
    <section id="pricing" className="py-32 bg-dark-900 relative overflow-hidden">
       {/* Background Elements */}
       ...
       <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <RevealOnScroll className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-display font-bold text-5xl md:text-6xl mb-6 text-white">Transparent <br/><span className="text-gray-500">Pricing.</span></h2>

...
const Ebook: React.FC = () => {
  return (
    <section id="ebook" className="py-24 md:py-32 bg-dark-900 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-brand-accent/5 rounded-full blur-[100px] animate-blob"></div>
          <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-white/5 rounded-full blur-[100px] animate-blob animation-delay-2000"></div>
      </div>
        ...
        <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-[3rem] p-8 md:p-16 relative overflow-hidden backdrop-blur-sm box-glow-hover transition-all duration-500 group/card">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
                ...
                <RevealOnScroll className="order-2 lg:order-1">
                    ...
                    <h2 className="font-display font-bold text-5xl md:text-6xl mb-6 text-white leading-[0.95] tracking-tight">
                ...
                <RevealOnScroll delay={200} className="order-1 lg:order-2 flex justify-center lg:justify-end perspective-[2000px]">
                     <div className="relative w-72 md:w-80 aspect-[3/4] group cursor-pointer animate-float-slow preserve-3d">

...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    // Primary: Strong lime background with an electric glow
    primary: "bg-brand-accent text-dark-950 hover:bg-white hover:scale-105 shadow-[0_0_20px_rgba(163,230,53,0.3)] hover:shadow-[0_0_35px_rgba(163,230,53,0.6)] font-bold",
    
    // Outline: Glassmorphism feel with lime border on hover
    outline: "border border-white/10 text-white bg-white/5 backdrop-blur-sm hover:bg-brand-accent/10 hover:border-brand-accent/50 hover:text-brand-accent hover:shadow-[0_0_20px_rgba(163,230,53,0.15)]",

...
const Growth: React.FC = () => {
  ...
  return (
    <section id="growth" className="py-24 md:py-32 bg-dark-900 relative border-t border-white/5 overflow-hidden">
       {/* Ambient Background */}
       <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-brand-accent/5 rounded-full blur-[150px] pointer-events-none -translate-y-1/2"></div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col h-full">
                <RevealOnScroll className="mb-12">
                    ...
                    <h2 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mb-6 text-white leading-[0.95]">
                ...
                {STEPS.map((step, idx) => (
                    ...
                    >
                      <div className="h-full w-full bg-dark-950/50 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-12 flex flex-col justify-center relative overflow-hidden group">
                          ...
                          <div className={`absolute top-0 right-0 w-[400px] h-[400px] rounded-full blur-[100px] opacity-20 transition-colors duration-500 ${step.bgGlow}`}></div>
